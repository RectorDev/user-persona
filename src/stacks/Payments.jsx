...
const Payments = () => {
  ...
  return (
      <div className={"flex flex-1 flex-col flex-start text-primary bg-white rounded-md p-4"}>
        <h2 className={"fo nt-bold font-palanquin font-bold "}>Payment medium</h2>
        <ul className={"list-none mt-4 pl-4 flex justify-start flex-wrap gap-4 items-center "}>
